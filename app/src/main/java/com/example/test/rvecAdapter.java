...
public class rvecAdapter extends RecyclerView.Adapter<rvecAdapter.viewHolder> {
    ...
    public rvecAdapter(Context context){
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent = new Intent(context, EcActivity.class);
